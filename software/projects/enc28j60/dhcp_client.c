...
uint8_t dhcp_yiaddr[4]={0,0,0,0}; // your (client) IP
...
uint8_t send_dhcp_discover(uint8_t *buf,const uint8_t transactionID)
{
        ...
        buf[UDP_DATA_P+DHCP_OPTION_OFFSET+4]=3; // len
        buf[UDP_DATA_P+DHCP_OPTION_OFFSET+5]=1; // subnet mask
        buf[UDP_DATA_P+DHCP_OPTION_OFFSET+6]=3; // router=default GW
        buf[UDP_DATA_P+DHCP_OPTION_OFFSET+7]=6; // DNS
        buf[UDP_DATA_P+DHCP_OPTION_OFFSET+8]=0xff; // end of options
        buf[UDP_DATA_P+DHCP_OPTION_OFFSET+9]=0; 
        // no padding
...
uint8_t send_dhcp_request(uint8_t *buf,const uint8_t transactionID)
{
        ...
        // we want: subnet mask, router
        buf[UDP_DATA_P+DHCP_OPTION_OFFSET+i+1]=3; // len
        buf[UDP_DATA_P+DHCP_OPTION_OFFSET+i+2]=1; // subnet mask
        buf[UDP_DATA_P+DHCP_OPTION_OFFSET+i+3]=3; // router=default GW
        buf[UDP_DATA_P+DHCP_OPTION_OFFSET+i+4]=6; // DNS server
        buf[UDP_DATA_P+DHCP_OPTION_OFFSET+i+5]=0xff; // end of options
        buf[UDP_DATA_P+DHCP_OPTION_OFFSET+i+6]=0; 
