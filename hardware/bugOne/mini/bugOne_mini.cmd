...
# Start of element U3
ChangePinName(U3, 4, TAB)
ChangePinName(U3, 3, VOUT)
...
# Start of element U2
ChangePinName(U2, 14, nSEL)
ChangePinName(U2, 13, SCK)
ChangePinName(U2, 7, GND)
ChangePinName(U2, 11, nINT)
ChangePinName(U2, 10, GND)
ChangePinName(U2, 9, VDD)
ChangePinName(U2, 8, ANT)
ChangePinName(U2, 6, nRES)
ChangePinName(U2, 5, CLK)
ChangePinName(U2, 4, DCLK)
ChangePinName(U2, 3, FSK)
ChangePinName(U2, 2, nIRQ)
...
ChangePinName(U1, 32, "PD2 (INT0/PCINT18)")
ChangePinName(U1, 31, "PD1 (TXD/PCINT17)")
ChangePinName(U1, 30, "PD0 (RXD/PCINT16)")
ChangePinName(U1, 8, "PB7 (PCINT7/XTAL2/TOSC2)")
ChangePinName(U1, 7, "PB6 (PCINT6/XTAL1/TOSC1)")
ChangePinName(U1, 17, "PB5 (SCK/PCINT5)")
ChangePinName(U1, 16, "PB4 (PCINT4/MISO)")
ChangePinName(U1, 15, "PB3 (PCINT3/OC2A/MOSI)")
ChangePinName(U1, 14, "PB2 (PCINT2/OC1B)")
ChangePinName(U1, 13, "PB1 (PCINT1/OC1A)")
ChangePinName(U1, 12, "PB0 (PCINT0/CLK0/ICP1)")
ChangePinName(U1, 29, "(_RESET_/PCINT14) PC6")
ChangePinName(U1, 28, "(ADC5/PCINT13) PC5")
ChangePinName(U1, 27, "(ADC4/PCINT12) PC4")
